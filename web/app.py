...
def main():
    ...
    st.markdown("### 🏗️ **МОДУЛЬНАЯ АРХИТЕКТУРА** - Продвинутая нейросеть для анализа и прогнозирования")
    
    # Информация о новой архитектуре
    create_info_box(
        "Новая модульная архитектура", 
        "Система полностью переработана с использованием модульной архитектуры для улучшенной производительности и поддерживаемости"
    )
