...
from ml.core.features import FeatureExtractor
from config.logging_config import setup_logger  # Добавляем импорт

logger = setup_logger('EnhancedPredictor')
